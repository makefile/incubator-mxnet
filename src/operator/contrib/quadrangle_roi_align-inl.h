...
*/
#ifndef MXNET_OPERATOR_CONTRIB_QROI_ALIGN_INL_H_
#define MXNET_OPERATOR_CONTRIB_QROI_ALIGN_INL_H_
...
namespace roialign {
enum QROIAlignOpInputs {kData, kBox};
enum QROIAlignOpOutputs {kOut};
}  // roialign


struct QROIAlignParam : public dmlc::Parameter<QROIAlignParam> {
  TShape pooled_size;
  float spatial_scale;
  int sample_ratio;
  DMLC_DECLARE_PARAMETER(QROIAlignParam) {
...
#endif  // MXNET_OPERATOR_CONTRIB_QROI_ALIGN_INL_H_
